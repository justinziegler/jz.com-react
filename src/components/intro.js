    ...
    <p>
      ...
      { !mobile &&
        <>
          ...
          Most of the projects featured here can be <br /> explored in more depth on my <a href="https://github.com/justinziegler" rel="noreferrer" target="_blank">Github</a>.<br />
          Thanks for visiting!
        </>
      }
      { mobile && 
