const pageDetails = [
  {
    ...
    background: '../assets/holiday-promotion/carousel01-mob-vp.jpg'
  },
  {
  ...
  },,
  {
    ...
    background: '../assets/exploded-thumb.jpg'
  },
  {
    title: 'Tiktok Mimic',
    url: 'tiktok',
    ...
    background: '../assets/promos/tiktok-02.jpg'
  },
  {
    ...
    background: '../assets/sheets/closeup-making-bed.jpg'
  },
  {
    title: 'Bed Frame PDP',
    url: 'bed-frame',
    ...
    background: '../assets/frame/couple-in-bed-mobile.jpg'
  },
  {
    title: 'Bed Sheets PDP',
    url: 'sheets',
    intro: 'The following pages highlight the features of a Product Display template that I developed to support a line of bedding products. This project came about from a need to:',
    background: '../assets/sheets/photo-parachute.jpg'
  },
  {
    title: 'Shopping Cart',
    url: 'cart',
    intro: 'This page was developed to replace the company\'s existing shopping cart with an experience that:',
    background: '../assets/wood-frame-2.jpg'
  }, 
]
